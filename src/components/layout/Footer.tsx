    ...
    <footer className="bg-[var(--charcoal)] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-widest text-white/60 font-inter mb-4">
              Navigation
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              >
                <Phone size={16} aria-hidden="true" className="mt-0.5 flex-shrink-0 text-[var(--teal-light)]" />
              ...
              <li>
                ...
                >
                  <Mail size={16} aria-hidden="true" className="mt-0.5 flex-shrink-0 text-[var(--teal-light)]" />
                  <span className="text-sm font-inter break-all">{SITE.email}</span>
                </a>
              </li>
              <li>
                <div className="flex items-start gap-3 text-white/70">
                  <MapPin size={16} aria-hidden="true" className="mt-0.5 flex-shrink-0 text-[var(--teal-light)]" />
